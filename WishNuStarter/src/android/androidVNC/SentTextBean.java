...
public class SentTextBean extends
		com.antlersoft.android.dbimpl.IdImplementationBase implements ISentText {
	...
	public static String GEN_CREATE = "CREATE TABLE SENT_TEXT ("
			+ "_id INTEGER PRIMARY KEY AUTOINCREMENT," + "SENTTEXT TEXT" + ")";
	...
	public void Gen_populate(android.database.Cursor cursor, int[] columnIndices) {
		...
		if (columnIndices[GEN_ID_SENTTEXT] >= 0
				&& !cursor.isNull(columnIndices[GEN_ID_SENTTEXT])) {
